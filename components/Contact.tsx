      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            {/* App Store badge */}
            <a href="https://apps.apple.com/de/app/captn-ki-fitness-ern%C3%A4hrung/id6759269133" target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3 transition-all hover:bg-white/10">
          ...
          <div>
            ...
            <ul className="space-y-4 text-base font-medium">
              {[
                ...
                { href: "https://apps.apple.com/de/app/captn-ki-fitness-ern%C3%A4hrung/id6759269133", label: "App laden" },
                { href: "/#faq", label: "FAQ" },
              ].map((l) => (
                <li key={l.href}>
                  <Link
